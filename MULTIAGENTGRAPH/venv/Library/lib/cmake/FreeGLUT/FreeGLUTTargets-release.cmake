...
set_target_properties(FreeGLUT::freeglut PROPERTIES
  IMPORTED_IMPLIB_RELEASE "E:/GenAI/Agents/MULTIAGENTGRAPH/venv/Library/lib/glut.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/glut.dll"
  )

list(APPEND _cmake_import_check_targets FreeGLUT::freeglut )
list(APPEND _cmake_import_check_files_for_FreeGLUT::freeglut "E:/GenAI/Agents/MULTIAGENTGRAPH/venv/Library/lib/glut.lib" "${_IMPORT_PREFIX}/bin/glut.dll" )
